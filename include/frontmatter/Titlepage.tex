...
{\Large NIKOLAOS ALEXANDRIS} \setlength{\parskip}{2.9cm}
...
\oneLineTitle\\
% \oneLineSubtitle\\
NIKOLAOS ALEXANDRIS \setlength{\parskip}{1cm}

\copyright ~ NIKOLAOS ALEXANDRIS, \the\year. \setlength{\parskip}{1cm}

Supervisor: Magnus Myreen, Department\\
Examiner: Krasimir Angelov, Department \setlength{\parskip}{1cm}
